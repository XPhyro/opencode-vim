  ...
  try {
    ...
    const task = Effect.runPromise(
      run({
        url: "http://test",
        directory,
        config: createTuiResolvedConfig({ plugin_enabled: {}, vim: false }),
        fetch,
    ...
    if (!(textarea instanceof core.TextareaRenderable)) throw new Error("expected focused child prompt textarea")
    textarea.insertText("Continue this task")
    expect(textarea.plainText).toBe("Continue this task")
